...
const CustomPopup: FC = () => {
  ...
  return (
    <div className="relative font-karla">
      ...
      {isVisible && (
        <div
          className="absolute p-4 left-[-50px] w-40 z-50 mt-2 rounded-md shadow-2xl bg-white text-zinc-800 ring-1 transition-all ring-black ring-opacity-5 focus:outline-none"
